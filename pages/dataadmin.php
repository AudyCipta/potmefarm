      ...
      <div class="container-fluid" style="width:1050px;">
        <div class="row" style="padding: 10px;">
          ...
          <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
              <a href="tambahadmin.php"><button type="button" class="btn btn-success btn-md"><i class="fa fa-plus"></i> Tambah Admin</button></a><br><br>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php
                    $no=0;
                    $sql = mysqli_query($process->cnt,"SELECT * FROM tbuser WHERE Level = '1'");
                    while ($res = mysqli_fetch_array($sql)) {
                      ...
                      echo "
                        <tr>
                          ...
                          <td>".$res['Email']."</td>
                          <td align='center'>
                            <a href='editadmin.php?KodeUser=".$res['KodeUser']."'>
                              <button class='btn btn-success' data-toggle='modal' style='border-radius:50%;' title='Edit'>
                                <i class='fa fa-pen'></i>
                              </button>
                            </a>
                            <form action='../process/handler.php?action=hapusadmin' method='post'>
