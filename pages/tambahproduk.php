      ...
      <div class="container-fluid">
        <div class="row" style="padding: 10px;">
          ...
          <div class="card"style="width: 100%">
            ...
            <!-- /.card-header -->
            <div class="card-body">
              <form method="post" action="../process/handler.php?action=tambahproduk" enctype="multipart/form-data">
                <div class="col-lg-6 col-md-6 col-sm-12 left" style="padding:10px;">
                  <div class="inputBox">
                    ...
                    <img onclick="$('#FotoProduk').click()" src="../public/img/white.jpg" width="100%" height="100%" alt="" style="border: 5px #ccc solid;cursor: pointer;" id="valuePicture1">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 left" style="padding:10px;"> 
                  <div class="inputBox" id="NamaProdukBox">
                    <label for="NamaProduk" class="inputBoxLabel">Nama Produk</label>
                    <input type="text" id="NamaProduk" name="NamaProduk" onblur="formAni('NamaProdukBox')" onfocus="formAni2('NamaProdukBox')" class="form form-control symbol-protection2" required autocomplete="off">
                  </div><br>
                  <div class="inputBox" id="KodeJenisBox">
                    <select name="KodeJenis" id="KodeJenis" class="form form-control">
                      <option value="" selected="on" disabled="on" class="none">Pilih Jenis</option>
                      <?php
                  ...
                  <div class="inputBox" id="SatuanBox">
                    <label for="Satuan" class="inputBoxLabel">Satuan</label>
                    <input type="text" id="Satuan" name="Satuan" onblur="formAni('SatuanBox')" onfocus="formAni2('SatuanBox')" class="form form-control" required autocomplete="off">
                  </div><br>
                  ...
                  <div class="inputBox" id="StokBox">
                    <label for="Stok" class="inputBoxLabel">Stok</label>
                    <input type="number" id="Stok" name="Stok" onblur="formAni('StokBox')" onfocus="formAni2('StokBox')" class="form form-control numberonly" required autocomplete="off">
                  </div><br>
                  <div class="inputBox" id="KeteranganBox">
                    <label for="Keterangan" class="inputBoxLabel inputBoxLabel2">Keterangan</label>
                    <textarea type="text" id="Keterangan" name="Keterangan" onblur="formAni('KeteranganBox')" onfocus="formAni2('KeteranganBox')" class="form form-control ckeditor" required></textarea>
                  </div><br>
