							...
							<ul class="navbar_user">
								<li class="checkout">
										<?php
											...
											if (empty($KodeUser)) {
												echo "
													<a href='javascript:void(0);' data-toggle='modal' data-target='#ModalLogin' title='Keranjang'>
												";
											}
											else{
								...
								<li class="checkout">
									<?php
										...
										if ($no > 0) {
											...
											echo "<a href='javascript:void(0);'  data-toggle='modal' data-target='#ModalLogin' title='Tagihan'>";
										}
									?>
								...
								<li class="checkout">
									<?php
										...
										if (!empty($_COOKIE['KodeUser'])) {
											...
											echo "<a href='javascript:void(0);'  data-toggle='modal' data-target='#ModalLogin' title='Transaksi'>";
										}
									?>
