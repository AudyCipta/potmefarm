      ...
      <div class="container-fluid">
        <div class="row" style="padding: 10px;">
          <div class="card"style="width: 100%">
            ...
            <!-- /.card-header -->
            <div class="card-body">
              <form method="post" action="../process/handler.php?action=tambahadmin" enctype="multipart/form-data">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 left" style="padding:10px;"> 
                  <div class="inputBox" id="NamaadminBox">
                    <label for="NamaLengkap" class="inputBoxLabel">Nama admin</label>
                    <input type="text" id="NamaLengkap" name="NamaLengkap" onblur="formAni('NamaadminBox')" onfocus="formAni2('NamaadminBox')" class="form form-control" required autocomplete="off">
                  </div><br>
