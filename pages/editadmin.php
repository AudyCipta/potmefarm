...
<?php
  ...
  if (!empty($KodeUser)) {
    $sql = mysqli_query($process->cnt,"SELECT * FROM tbuser WHERE KodeUser = '$KodeUser' AND Level = '1'");
    $x = 0;
    ...
    if ($x == 0) {
      ...
      echo "<script>document.location='dataadmin.php'</script>";
      return false;
    }
  }
  else{
    echo "<script>alert('Pilih admin yang akan diubah')</script>";  
    echo "<script>document.location='dataadmin.php'</script>"; 
    return false;
  }
?>
      ...
      <div class="container-fluid">
        ...
        ?>
          <div class="card"style="width: 100%">
            ...
            <!-- /.card-header -->
            <div class="card-body">
              <form method="post" action="../process/handler.php?action=editadmin" enctype="multipart/form-data">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 left" style="padding:10px;"> 
                  <div class="inputBox" id="NamaadminBox">
                    <label for="NamaLengkap" class="inputBoxLabel inputBoxLabel2">Nama admin</label>
                    <input type="text" id="NamaLengkap" name="NamaLengkap" onblur="formAni('NamaadminBox')" onfocus="formAni2('NamaadminBox')" class="form form-control" required autocomplete="off" value="<?php echo $res['NamaLengkap'] ?>">
                  </div><br>
                ...
                <div class="col-12 left buttonDiv" style="padding:10px;" align="right">
                  <a href="dataadmin.php"><button class="btn btn-danger" type="button">Kembali</button></a>
