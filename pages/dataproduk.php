      ...
      <div class="container-fluid" style="width:1060px;">
        <div class="row" style="padding: 10px;">
          ...
          <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
              <a href="tambahproduk.php"><button type="button" class="btn btn-success btn-md"><i class="fa fa-plus"></i> Tambah Produk</button></a><br><br>
                ...
                <tbody>
                  <?php
                    ...
                    while ($res = mysqli_fetch_array($sql)) {
                      ...
                      $sql1 = mysqli_query($process->cnt,"SELECT * FROM tbjenisproduk WHERE KodeJenis = '$KodeJenis'");
                      $res1 = mysqli_fetch_array($sql1);
                      echo "
                        <tr>
                          <td>".$no."</td>
                          <td><img src='../public/img/produk/".$res['Foto']."' width='100%'></td>
                          <td>".$res['NamaProduk']."</td>
                          <td>".$res1['NamaJenis']."</td>
                          <td>RP.".number_format($res['Harga'])."</td>
                          <td align='center'>".$res['Stok']." ".$res['Satuan']."</td>
                          <td align='center'>
                            <a href='editproduk.php?KodeProduk=".$res['KodeProduk']."'>
                          ...
                          <td align='center'>
                            <form action='../process/handler.php?action=hapusproduk' method='post'>
                              <input type='hidden' name='KodeProduk' value='".$res['KodeProduk']."'>
