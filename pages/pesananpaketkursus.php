...
<body class="bg-light">
			<!-- <a href="pembayarankursus.php?nt=<?= $_GET['nt']; ?>"><button style="font-size: 15px;" class="btn btn-sm btn-success" title='Bayar'><i class="fa fa-dollar-sign"></i> Konfirmasi Order</button></a> -->
	...
	?>
				...
				<?php
					...
					$nt = $_GET['nt'];
					if (!empty($nt)){
						$sqlz = mysqli_query($process->cnt,"SELECT * FROM tbpesankursus WHERE NoTransaksi = '$nt' AND StatusKursus = 'Sudah Order'");
				...
				<!-- <div class="row" style="margin-top: 100px;width: 100%;padding: 20px;margin-left: 0px;">
						<table id="example1" class="table table-bordered" style="background-color: #fff;">
		                  ...
		                  <?php
		                    ...
		                    $NoTransaksix = [];
		                    $sementara = '';
		                    $sqlx = mysqli_query($process->cnt,"SELECT NoTransaksi FROM tbpesankursus WHERE StatusKursus = 'Sudah Order' AND KodePelanggan = '$KodeUser' AND NoTransaksi = '$nt' ORDER BY KodePelanggan");
		                        ...
		                        $res = mysqli_fetch_array($sql);
		                          ...
		                          echo "
				                	...
				                	<tr>
				                		...
				                		<td style='min-width:100px;' align='center'><b>Durasi</b></td>
		                          ...
		                          ";
		                            ...
		                            while($res2 = mysqli_fetch_array($sql2)){
										...
										if ($nos == 1) {
											...
											if ($res2['StatusKursus'] == 'Sudah Order') {
												$color1 = 'red';
											}

											else if ($res2['StatusKursus'] == 'Sudah Transfer') {
												$color1 = 'blue';
											}
		                              ...
		                              echo "
					                		<td>* ".$res2a[0]."</td>
					                		<td align='center'>".number_format($res2['Durasi'])." Jam</td>
											...
											<?php  
												...
												while($res = mysqli_fetch_array($sql)){
													...
													?>
														<tr>
															<td><?= $number ?></td>
															<td><img src="../public/img/paketkursus/<?= $res_kursus['Foto'] ?>" alt="" width='70px'></td>
															<td style="min-width: 200px;padding-left: 0px;"><?= $res_kursus['NamaProduk'] ?></td>
						...
						<div class="nt-info col-sm-12" style="overflow: auto;" align="right">
							<div class="verticalAlign1" align="right">
								<div class="verticlaAlign2" align="right">
									...
									<br>
									<a href="pembayarankursus.php?nt=<?= $_GET['nt']; ?>"><button class="btn btn-xs btn-success" title='Bayar'>Konfirmasi Order</button></a>
								</div>
							</div>
						</div>
					</div>
