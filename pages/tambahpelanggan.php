      ...
      <div class="container-fluid">
        <div class="row" style="padding: 10px;">
          <div class="card"style="width: 100%">
            ...
            <!-- /.card-header -->
            <div class="card-body">
              <form method="post" action="../process/handler.php?action=tambahpelanggan" enctype="multipart/form-data">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 left" style="padding:10px;"> 
                  <div class="inputBox" id="NamaPelangganBox">
                    <label for="NamaLengkap" class="inputBoxLabel">Nama Pelanggan</label>
