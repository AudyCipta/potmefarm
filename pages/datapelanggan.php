      ...
      <div class="container-fluid" style="width:1050px;">
        <div class="row" style="padding: 10px;">
          ...
          <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
              <a href="tambahpelanggan.php"><button type="button" class="btn btn-success btn-md"><i class="fa fa-plus"></i> Tambah Pelanggan</button></a><br><br>
                    ...
                    while ($res = mysqli_fetch_array($sql)) {
                      ...
                      echo "
                        <tr>
                          ...
                          <td>".$res['Email']."</td>
                          <td align='center'>
                            <a href='editpelanggan.php?KodeUser=".$res['KodeUser']."'>
                              <button class='btn btn-success' data-toggle='modal' style='border-radius:50%;' title='Edit'>
                                <i class='fa fa-pen'></i>
                              </button>
                            </a>
                            <form action='../process/handler.php?action=hapuspelanggan' method='post'>
