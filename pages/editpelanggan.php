...
<?php
  ...
  if (!empty($KodeUser)) {
    $sql = mysqli_query($process->cnt,"SELECT * FROM tbuser WHERE KodeUser = '$KodeUser' AND Level = '3'");
    $x = 0;
    ...
    if ($x == 0) {
      ...
      echo "<script>document.location='datapelanggan.php'</script>";
      return false;
    }
  }
  else{
    echo "<script>alert('Pilih pelanggan yang akan diubah')</script>";  
    echo "<script>document.location='datapelanggan.php'</script>"; 
    return false;
  }
?>
      ...
      <div class="container-fluid">
        ...
        ?>
          <div class="card"style="width: 100%">
            ...
            <!-- /.card-header -->
            <div class="card-body">
              <form method="post" action="../process/handler.php?action=editpelanggan" enctype="multipart/form-data">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 left" style="padding: 10px"> 
                  <div class="inputBox" id="NamaPelangganBox">
                    <label for="NamaLengkap" class="inputBoxLabel inputBoxLabel2">Nama Pelanggan</label>
                    <input type="text" id="NamaLengkap" name="NamaLengkap" onblur="formAni('NamaPelangganBox')" onfocus="formAni2('NamaPelangganBox')" class="form form-control" required autocomplete="off" value="<?php echo $res['NamaLengkap'] ?>">
                  </div><br>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <form action="../process/handler.php?action=gantipassworduser" method="post">
        ...
        <input type="hidden" name="to" value="Pelanggan">
